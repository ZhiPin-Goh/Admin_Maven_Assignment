        ...
        <div class="flex-1 flex flex-col h-full overflow-hidden bg-[#f6f8f6]">
          <header class="px-8 py-6 shrink-0 bg-white border-b border-gray-200 shadow-sm">
            <div class="max-w-[1400px] mx-auto">
              <h2 class="text-3xl font-black text-[#0d1b12] tracking-tight">Drink Options</h2>
              ...
              <div class="bg-white rounded-2xl border border-[#cfe7d7] shadow-sm overflow-hidden flex flex-col h-fit">
                <div class="p-6 border-b border-[#cfe7d7] flex items-center justify-between bg-[#f6f8f6]/50">
                  <div class="flex items-center gap-3">
                    <div class="p-2 bg-[#13ec5b]/20 rounded-lg">
                    ...
                    <h3 class="font-bold text-[#0d1b12]">Ice Level</h3>
                  </div>
                  <button type="button" onclick="openAddModal('ice')" class="p-1.5 hover:bg-[#13ec5b]/20 rounded-lg transition-colors text-[#0eb545]">
                ...
                <div class="p-4 space-y-3">
                  <c:forEach var="ice" items="${ices}">
                    <div class="group flex items-center justify-between p-3 rounded-xl border border-gray-100 bg-white hover:border-[#13ec5b]/30 hover:shadow-sm transition-all">
                        <div class="flex-1 flex items-center justify-between mr-4">
                            <span class="text-sm font-bold text-[#0d1b12]">${ice.iceOption}</span>
              ...
              <div class="bg-white rounded-2xl border border-[#cfe7d7] shadow-sm overflow-hidden flex flex-col h-fit">
                <div class="p-6 border-b border-[#cfe7d7] flex items-center justify-between bg-[#f6f8f6]/50">
                  <div class="flex items-center gap-3">
                    ...
                    <h3 class="font-bold text-[#0d1b12]">Sugar Level</h3>
                  </div>
                  <button type="button" onclick="openAddModal('sugar')" class="p-1.5 hover:bg-[#13ec5b]/20 rounded-lg transition-colors text-[#0eb545]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                  </button>
                </div>
                <div class="p-4 space-y-3">
                  <c:forEach var="sugar" items="${sugars}">
                    <div class="group flex items-center justify-between p-3 rounded-xl border border-gray-100 bg-white hover:border-[#13ec5b]/30 hover:shadow-sm transition-all">
                        <div class="flex-1 flex items-center justify-between mr-4">
                            <span class="text-sm font-bold text-[#0d1b12]">${sugar.sugarOption}</span>
              ...
              <div class="bg-white rounded-2xl border border-[#cfe7d7] shadow-sm overflow-hidden flex flex-col h-fit">
                <div class="p-6 border-b border-[#cfe7d7] flex items-center justify-between bg-[#f6f8f6]/50">
                  <div class="flex items-center gap-3">
                    ...
                    <h3 class="font-bold text-[#0d1b12]">Cup Size</h3>
                  </div>
                  <button type="button" onclick="openAddModal('size')" class="p-1.5 hover:bg-[#13ec5b]/20 rounded-lg transition-colors text-[#0eb545]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                  </button>
                </div>
                <div class="p-4 space-y-3">
                  <c:forEach var="size" items="${sizes}">
                    <div class="group flex items-center justify-between p-3 rounded-xl border border-gray-100 bg-white hover:border-[#13ec5b]/30 hover:shadow-sm transition-all">
                        <div class="flex-1 flex items-center justify-between mr-4">
                            <span class="text-sm font-bold text-[#0d1b12]">${size.beverageSize}</span>
    ...
    <div id="addModal" class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center opacity-0 pointer-events-none transition-opacity duration-200 p-4">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-[400px] overflow-hidden transform translate-y-4 transition-transform duration-200" id="addModalContent">
            <header class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                <h3 class="text-xl font-bold text-[#0d1b12]" id="modalTitle">Add Option</h3>
            ...
            <form id="addForm" action="" method="post" class="p-6">
                ...
                <div class="space-y-4 mb-6">
                    <div id="nameInputWrapper">
                        ...
                        <input type="text" id="add_name_input" name="" required placeholder="e.g. Less Sugar, Large, Normal Ice" class="w-full px-4 py-2 bg-[#f6f8f6] border border-gray-200 focus:border-[#13ec5b] focus:ring-1 focus:ring-[#13ec5b] rounded-lg text-sm transition-colors outline-none">
                    </div>
                    ...
                    <div id="priceModifierWrapper" class="hidden">
                        ...
                        <input type="number" step="0.01" min="0" value="0.00" id="add_price_input" name="pricemodifier" class="w-full px-4 py-2 bg-[#f6f8f6] border border-gray-200 focus:border-[#13ec5b] focus:ring-1 focus:ring-[#13ec5b] rounded-lg text-sm transition-colors outline-none">
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-5 py-2 rounded-lg font-bold bg-[#13ec5b] hover:bg-[#0eb545] text-green-900 transition-colors text-sm shadow-sm">
                        Confirm Add
                    </button>
                </div>
            </form>
